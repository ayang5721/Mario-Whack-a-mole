...
class Luigi(Character):
    ...
    def __init__(self, screen, x, y):
        ...
        gif_path = 'graphics/luigi_Up.gif'
        ...
        gif_path = 'graphics/luigi_Down.gif'
        gif = Image.open(gif_path)
        for frame in range(gif.n_frames):
            gif.seek(frame)
            frame_image = gif.convert("RGBA")
        ...
        middleFrame = pygame.image.load('graphics/luigi.png')
    ...
    def display(self):
        ...
        luigi_img = self.frames[frameIndex]
        self.screen.blit(luigi_img, (self.x, self.y))